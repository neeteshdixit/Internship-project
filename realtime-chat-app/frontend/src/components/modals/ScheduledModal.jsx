...
export default function ScheduledModal() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }} onClick={() => closeModal('scheduled')}>
      <div style={{ backgroundColor: '#202c33', width: 'min(420px, calc(100vw - 24px))', maxHeight: 'min(520px, calc(100dvh - 32px))', borderRadius: '12px', overflow: 'hidden', boxShadow: '0 20px 60px rgba(0,0,0,0.5)', display: 'flex', flexDirection: 'column' }} onClick={(e) => e.stopPropagation()}>
        {/* Header */}
